...
The Monzo API is designed to be a predictable and intuitive interface for interacting with users' accounts. This API is **not suitable** for building public applications. More information on the Monzo API is available [here](https://docs.monzo.com/#introduction).
